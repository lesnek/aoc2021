...
#[cfg(test)]
mod test {
    use crate::day14::solution::*;
    use std::fs::read_to_string;

    #[test]
    fn test_solution1() {
        let content = read_to_string("data/day14_test.txt").unwrap();
    ...
    fn test_solution1_real_data() {
        let content = read_to_string("data/day14.txt").unwrap();
        let input = parse_input(&content);
        assert_eq!(solution1(&input), 2968);
    }
    ...
    fn test_solution2() {
        let content = read_to_string("data/day14_test.txt").unwrap();
        let input = parse_input(&content);
        assert_eq!(solution2(&input), 2188189693528);
    }
    ...
    fn test_solution2_real_data() {
        let content = read_to_string("data/day14.txt").unwrap();
        let input = parse_input(&content);
        assert_eq!(solution2(&input), 3692219987038);
    }
